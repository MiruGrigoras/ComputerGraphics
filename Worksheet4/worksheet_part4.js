window.onload = function init(){
    ...
    var diffuseProduct = vec4(0, 0.8, 1, 1);
    gl.p_buffer = null;
    gl.n_buffer = null;
    ...
    var normalMatrix = gl.getUniformLocation(program, 'normalMatrix');
    ...
    var ka = document.getElementById("kaInput");
    var kd = document.getElementById("kdInput");
    var ks = document.getElementById("ksInput");
    var alpha = document.getElementById("alphaInput");
    var Le = document.getElementById("leInput");
    
    var kaValue = document.getElementById("kaValue");
    var kdValue = document.getElementById("kdValue");
    var ksValue = document.getElementById("ksValue");
    var alphaValue = document.getElementById("alphaValue");
    var leValue = document.getElementById("leValue");

    gl.uniform1f(gl.getUniformLocation(program, "ka"), 0.5);
    gl.uniform1f(gl.getUniformLocation(program, "kd"), 0.5);
    gl.uniform1f(gl.getUniformLocation(program, "ks"), 0.5);
    gl.uniform1f(gl.getUniformLocation(program, "alpha"), 50);
    gl.uniform1f(gl.getUniformLocation(program, "Le"), 0.5);

    kaValue.innerHTML = 0.5;
    kdValue.innerHTML = 0.5;
    ksValue.innerHTML = 0.5;
    alphaValue.innerHTML = 50;
    leValue.innerHTML = 0.5;

    kaInput.addEventListener('input', function(){
        kaValue.innerHTML = this. value;
        gl.uniform1f(gl.getUniformLocation(program, "ka"), parseFloat(this.value));
    });

    kdInput.addEventListener('input', function(){
        kdValue.innerHTML = this. value;
        gl.uniform1f(gl.getUniformLocation(program, "kd"), parseFloat(this.value));
    });

    ksInput.addEventListener('input', function(){
        ksValue.innerHTML = this. value;
        gl.uniform1f(gl.getUniformLocation(program, "ks"), parseFloat(this.value));
    });

    alphaInput.addEventListener('input', function(){
        alphaValue.innerHTML = this. value;
        gl.uniform1f(gl.getUniformLocation(program, "alpha"), parseFloat(this.value));
    });

    leInput.addEventListener('input', function(){
        leValue.innerHTML = this. value;
        gl.uniform1f(gl.getUniformLocation(program, "Le"), parseFloat(this.value));
    });

window.onload = function init(){
    ...
    var texMatrix = gl.getUniformLocation(program, 'texMatrix');
    var reflective = gl.getUniformLocation(program, 'reflective');
    var eye_Position = gl.getUniformLocation(program, 'eye_Position');
    ...
    function rotate(){
        ...
        gl.uniform3fv(eye_Position, flatten(directions[0]));
